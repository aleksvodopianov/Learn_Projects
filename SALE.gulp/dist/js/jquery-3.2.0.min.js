...
!function (e, t) {
  ...
  m.event = {
    ...
    add: function (e, t, n, r, i) {
      var o,
          ...
          g,
          v = U.get(e);
      if (v) for (n.handler && (n = (o = n).handler, i = o.selector), i && m.find.matchesSelector(ve, i), n.guid || (n.guid = m.guid++), (u = v.events) || (u = v.events = {}), (a = v.handle) || (a = v.handle = function (t) {
    ...
    remove: function (e, t, n, r, i) {
      ...
      if (v && (u = v.events)) {
        for (l = (t = (t || "").match(P) || [""]).length; l--;) if (d = g = (s = xe.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d) {
    ...
    special: {
      ...
      click: {
        trigger: function () {
          if (ae.test(this.type) && this.click && N(this, "input")) return this.click(), !1;
        },
        _default: function (e) {
          return N(e.target, "a");
        }
  ...
  function Fe(e, t, n, r) {
    ...
    if (p && (o = (i = ge(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
      ...
      if (u) for (c = s[s.length - 1].ownerDocument, m.map(s, qe), f = 0; f < u; f++) l = s[f], ue.test(l.type || "") && !U.access(l, "globalEval") && m.contains(c, l) && (l.src ? m._evalUrl && m._evalUrl(l.src) : g(l.textContent.replace(De, ""), c));
    }
  ...
  m.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (!(h.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || m.isXMLDoc(e))) for (a = ce(s), r = 0, i = (o = ce(e)).length; r < i; r++) He(o[r], a[r]);
      if (t) if (n) for (o = o || ce(e), a = a || ce(s), r = 0, i = o.length; r < i; r++) Le(o[r], a[r]);else Le(e, s);
  ...
  function Qe(e, t, n) {
    ...
    return Re.test(o) ? o : (r = a && (h.boxSizingReliable() || o === e.style[t]), (o = parseFloat(o) || 0) + Ye(e, t, n || (a ? "border" : "content"), r, i) + "px");
  }
  ...
  function at(e, t, n) {
    ...
    }(c, l.opts.specialEasing); o < a; o++) if (r = at.prefilters[o].call(l, e, c, l.opts)) return m.isFunction(r.stop) && (m._queueHooks(l.elem, l.opts.queue).stop = m.proxy(r.stop, r)), r;
  ...
  m.fn.extend({
    ...
    addClass: function (e) {
      ...
      if ("string" == typeof e && e) for (t = e.match(P) || []; n = this[u++];) if (i = pt(n), r = 1 === n.nodeType && " " + ft(i) + " ") {
    ...
    toggleClass: function (e, t) {
      ...
      return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : m.isFunction(e) ? this.each(function (n) {
        ...
        var t, r, i, o;
        if ("string" === n) for (r = 0, i = m(this), o = e.match(P) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);else void 0 !== e && "boolean" !== n || ((t = pt(this)) && U.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : U.get(this, "__className__") || ""));
      });
    },
    hasClass: function (e) {
      var t,
